<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterUser.master" AutoEventWireup="true" CodeFile="Add_Item.aspx.cs" Inherits="UCMP_User_Add_Item_Item" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
      <%--Here, the <div> with id="divUpdateInfo" will be hidden and shown only after the employee searches for User Account Number--%>
    <div class="jumbotron" id="divUpdateInfo" style="width:960px;margin-left:0px;margin-top:0px">
    <div class="panel panel-default">
        <div class="panel-heading ">
            <h3 class="panel-title">Add New Items...</h3>
        </div>
        <div class="row">
...
<div class="col-md-offset-2">
      ...
      <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
        ...
        <div class="form-group" >
            ...
            <div class="col-md-offset-2">
              ...
              <asp:RequiredFieldValidator ID="RequiredFieldValidator2"  runat="server" ControlToValidate="txtBuyPrice"  Display="Dynamic" ErrorMessage="Price should not be empty" Font-Italic="True" Font-Size="Small" ForeColor="red" SetFocusOnError="True">* Price should not be empty</asp:RequiredFieldValidator>
                <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="txtBuyPrice" Display="Dynamic" ErrorMessage="Enter Price in Numeric" ForeColor="red" Font-Italic="True" Font-Size="Small" ValidationExpression="\d+[.]\d+">* Enter Price in Numeric</asp:RegularExpressionValidator>
 ...
 <div class="col-md-offset-2">
                <asp:TextBox ID="txtSalePrice" runat="server" CssClass="form-control" placeholder="Sale Price" Width="927px"></asp:TextBox>
                 <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                        ControlToValidate="txtSalePrice" Display="Dynamic" 
                        ErrorMessage="Price should not be empty" ForeColor="red" Font-Italic="True"
                        SetFocusOnError="True" Font-Size="Small">* Price should not be empty</asp:RequiredFieldValidator>
                    
                    
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" 
                        ControlToValidate="txtSalePrice" ErrorMessage="Enter Price in Numeric" Font-Size="Small" Font-Italic="True"
        ...
        <div class="form-group">
          ...
          <div class="col-md-offset-2">
                ...
                <asp:TextBox ID="txtQuantity" runat="server" CssClass="form-control" placeholder="Available Quantity"></asp:TextBox>
                        ...
                        ErrorMessage="Quantity should not be empty" ForeColor="red" 
                        SetFocusOnError="True" Font-Italic="True" Font-Size="Small">* Quantity should not be empty</asp:RequiredFieldValidator>
                    
              
                <asp:RegularExpressionValidator id="RegularExpressionValidator4"
                   ControlToValidate="txtQuantity" Font-Size="Small"
