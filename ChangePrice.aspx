<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterUser.master" AutoEventWireup="true" CodeFile="ChangePrice.aspx.cs" Inherits="ChangePrice" %>
    ...
    <div class="form-group">
     ...
     <div class="form-group">
            ...
            <div >
                ...
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False" DataKeyNames="nu_prod_id" DataSourceID="SqlDataSource3" Width="100%" CellPadding="4" ForeColor="#333333" GridLines="None" >
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Product Name" SortExpression="vc_prod_desc">
                            <EditItemTemplate>
                        ...
                        <asp:BoundField DataField="vc_item_code" HeaderText="Item Code" SortExpression="vc_item_code" />
                        <asp:HyperLinkField DataNavigateUrlFields="nu_prod_id" DataNavigateUrlFormatString="Edit_Item.aspx?Id={0}" HeaderText="Select" Text="Select" />
                    </Columns>
